        ...
        <div class="col-md-12">
          <!-- DIRECT CHAT PRIMARY -->
            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages" id="scrollchat" style="overflow: ; height: 400px;">
            ...
            <div class="box-footer" >
              ...
              <form action="" method="post">
                <div class="input-group" >
                      ...
                      <span class="input-group-btn">
                        ...
                        <input type="text" id="chatm" onkeyup="checkInput()" name="mensaje" placeholder="Escribe un mensaje" class="form-control">

                        <input type="submit" id="submitBtn" name="enviar" class="btn btn-primary btn-flat " style="display: none;">enviar</button>
              ...
              <?php
                ...
                if(isset($_POST['enviar'])) {
                  ...
                  $siguiente = mysqli_query("SELECT id_cch FROM c_chats WHERE de = '$de' AND para = '$para' OR de = '$para' AND para = '$de'");
...
<script>
var miDiv = document.getElementById("scrollchat");
miDiv.scrollTop = miDiv.scrollHeight;
</script>
<script>
  function checkInput() {
  var input = document.getElementById("chatm");
