...
<script>
  $(document).ready(function() {
    $('.dropdown.notifications-menu a').click(function() {
      var miVariable = 0;
  
      $.ajax({
        type: "POST",
        url: "http://localhost/redsocial-master/index.php",
        data: {
          variableJS: miVariable
        },
  ...
  <![endif]-->
  <!--<script src="C:\xampp\htdocs\redsocial-master\js\actualizarnoti.js"></script> -->
  <!-- codigo scroll -->
