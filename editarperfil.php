      ...
      <div class="row">
             ...
             $comprobar = mysqli_num_rows(mysqli_query($connect,"SELECT * FROM usuarios WHERE usuario = '$usuario' AND id_use != '$id'"));
              if($comprobar == 0){
                ...
                if(!in_array($ext, $valid_exts)) {
                    echo 'Error: El archivo debe ser una imagen en formato JPG, PNG o GIF.';
                } else {
                    $type = 'jpg';
                    $name = $id.'_'.time().'.'.$ext;
                    ...
                    if(is_uploaded_file($rfoto))
                    {
                      ...
                      $nombrea = $name;
                      copy($rfoto, $destino);
                      $sql = mysqli_query($connect,"UPDATE usuarios SET avatar = '$nombrea' WHERE id_use = '$id'");
                    }

                    $sql = mysqli_query($connect,"UPDATE usuarios SET nombre = '$nombre', usuario = '$usuario', email = '$email', sexo = '$sexo', nacimiento = '$nac' WHERE id_use = '$id'");
        ...
        <div class="col-md-4">          
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <div style="overflow: auto; width: 700px; height: auto; max-height: 300px;">
              <ul class="products-list product-list-in-box">

              <?php $amistade = mysqli_query($connect,"SELECT * FROM amigos WHERE para = '".$_SESSION['id']."' AND estado = '0' order by id_ami desc");
              while($am = mysqli_fetch_array($amistade)) { 
                ...
                <li class="item">
                  <div class="product-img">
                   <a href="perfil.php?id=<?php echo $am['de'];?>"> <img src="avatars/<?php echo $us['avatar']; ?>" alt="Product Image"></a>
                  </div>
        ...
        <div class="col-md-4">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  ...
                  <?php $registrados = mysqli_query($connect,"SELECT avatar,usuario,fecha_reg,id_use FROM usuarios order by id_use desc limit 8");
                  while($reg=mysqli_fetch_array($registrados)) 
                  {
                  ?>
                    <li>
                      <img src="avatars/<?php echo $reg['avatar']; ?>" alt="User Image">
                      <a class="users-list-name" href="perfil.php?id=<?php echo $reg['id_use'];?>"><?php echo $reg['usuario']; ?></a>
